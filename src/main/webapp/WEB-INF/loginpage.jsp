        ...
        <div style="margin-top: 5em;" class="container">
            <form name="login" action="${pageContext.request.contextPath}/fc/logincommand"  method="POST">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control" type="text" name="email" placeholder="someone@nowhere.com" id="email">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-1 col-form-label" for="password">Password</label>
                    <div class="col-sm-4">
                        <input class="form-control" type="password" name="password" placeholder="sesam" id="password">
                    </div>
                </div>
